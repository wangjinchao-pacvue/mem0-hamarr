...
class MemoryClient:
    ...
    def add(self, messages: Union[str, List[Dict[str, str]]], **kwargs) -> Dict[str, Any]:
        ...
        response.raise_for_status()
        capture_client_event("client.add", self, {**kwargs})
    ...
    def search(self, query: str, version: str = "v1", **kwargs) -> List[Dict[str, Any]]:
        ...
        response.raise_for_status()
        capture_client_event("client.search", self, {"version": version, **kwargs})
        return response.json()
    ...
    def delete_all(self, **kwargs) -> Dict[str, str]:
        ...
        response.raise_for_status()
        capture_client_event("client.delete_all", self, {**kwargs})
        return response.json()
...
class AsyncMemoryClient:
    ...
    async def add(self, messages: Union[str, List[Dict[str, str]]], **kwargs) -> Dict[str, Any]:
        ...
        response.raise_for_status()
        capture_client_event("async_client.add", self.sync_client, {**kwargs})
        return response.json()
    ...
    async def get_all(self, version: str = "v1", **kwargs) -> List[Dict[str, Any]]:
        ...
        response.raise_for_status()
        capture_client_event(
            "async_client.get_all", self.sync_client, {"version": version, **params}
        )
        return response.json()
    ...
    async def search(self, query: str, version: str = "v1", **kwargs) -> List[Dict[str, Any]]:
        ...
        response.raise_for_status()
        capture_client_event("async_client.search", self.sync_client, {"version": version, **kwargs})
        return response.json()
    ...
    async def delete_all(self, **kwargs) -> Dict[str, str]:
        ...
        response.raise_for_status()
        capture_client_event("async_client.delete_all", self.sync_client, {**kwargs})
        return response.json()
